...
#$clientSecret = "75K8Q~CHBTZiZl9kYtayWmrcL-xMLLykMoZGUbmY" | ConvertTo-SecureString -AsPlainText -Force
#$connectCreds = New-Object -TypeName System.Management.Automation.PSCredential -ArgumentList "74dd694b-dfbc-4188-9147-ded0fb71d406", $clientSecret
#Connect-PowerBIServiceAccount -Tenant 272c3ca3-ccc2-49e8-aa06-76c8fb318ac4 -ServicePrincipal -Credential $connectCreds
